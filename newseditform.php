...
<body>
 ...
 $id = 1;
$get_data = "SELECT * FROM news WHERE id = $id";
...
while($row = mysqli_fetch_array($run_data))
{
	...
	echo "
      ...
      <div class='modal-body'>
        <form action='newsedit.php?id=$id' method='post'>
        	...
        	<div class='form-group'>
        		...
        		<textarea id='w3review' name='latestnews' rows='4' cols='50'>$latestnews</textarea>
        	</div>
