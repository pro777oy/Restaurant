...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body { background: url(admin/img/header.jpg) !important; }
		</style>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="forgetpasswordfunc.php" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Password">
								...
								<input class="input-large span10" name="food"  type="text" placeholder="type your favourite food"/>
							</div>
							<div class="clearfix"></div>
							...
							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="password"  type="text" placeholder="type new password"/>
							</div>
							<div class="clearfix"></div>
