	...
	<!-- start: Header -->
        ...
        <form action="usersearch.php" method="POST" >
        	...
        	<div class="form-group">
        	 ...
        	 <input type="submit" name="search" class="btn btn-info btn-large" value="Search">
		...
		<?php
        	...
        	while($row = mysqli_fetch_array($run_data))
        	{
				...
				<td class='text-center'>
					<a href='messagedelete.php?id=$id'><i class='halflings-icon trash'></i><span class='hidden-tablet'></span></a>
