...
<body>
 ...
 $id = 1;
$get_data = "SELECT * FROM contact WHERE id = $id";
...
while($row = mysqli_fetch_array($run_data))
{
	...
	echo "
      ...
      <div class='modal-header'>
             ...
             <h4 class='modal-title text-center'>Update The Data</h4> 
      </div>

      <div class='modal-body'>
        <form action='contactedit.php?id=$id' method='post'>
        	...
        	<div class='form-group'>
        		...
        		<input type='text' name='firstpost' class='form-control' value='$firstpost'>
        	</div>
        	<div class='form-group'>
        		<label>First Post Description</label>
        		
        		<textarea id='w3review' name='firstdescription' rows='4' cols='50'>$firstdescription</textarea>
        	</div>
        	<div class='form-group'>
        		<label>Second Post Title</label>
        		<input type='text' name='secondpost' class='form-control' value='$secondpost'>

        	</div>
        	<div class='form-group'>
        		<label>Second Post Description</label>
        		

        		<textarea id='w3review' name='seconddescription' rows='4' cols='50'>$seconddescription</textarea>
        	</div>
        	...
        	<div class='form-group'>
        		...
        		<input type='text' name='mediaone' class='form-control' value='$mediaone'>

        	</div>
        	<div class='form-group'>
        		<label>Social Media-2</label>
        		<input type='text' name='mediatwo' class='form-control' value='$mediatwo'>

        	</div>
        	<div class='form-group'>
        		<label>Social Media-3</label>
        		<input type='text' name='mediathree' class='form-control' value='$mediathree'>

        	</div>

        	<div class='form-group'>
        		<label>Social Media-4</label>
        		<input type='text' name='mediafour' class='form-control' value='$mediafour'>
</div>
