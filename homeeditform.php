...
<body>
 ...
 $id = $_GET['id'];
$get_data = "SELECT * FROM home WHERE id = $id";
...
while($row = mysqli_fetch_array($run_data))
{
	...
	echo "
      ...
      <div class='modal-header'>
             ...
             <h4 class='modal-title text-center'>Update The Image</h4> 
      </div>

      <div class='modal-body'>
        <form action='homeedit.php?id=$id' method='post' enctype='multipart/form-data'>
