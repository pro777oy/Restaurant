...
<body>
		...
		<?php
        	...
        	while($row = mysqli_fetch_array($run_data))
        	{
				...
				<td class='text-center'>
					<a href='homeeditform.php?id=$id'><i class='halflings-icon edit'></i><span class='hidden-tablet'></span></a>
					
				</td>

				<td class='text-center'>
					<a href='homedelete.php?id=$id'><i class='halflings-icon trash'></i><span class='hidden-tablet'></span></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="homeadd.php" method="POST" enctype="multipart/form-data">
