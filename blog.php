		...
		<?php
        	...
        	while($row = mysqli_fetch_array($run_data))
        	{
				...
				<td class='text-center'>
					<a href='blogeditform.php?id=$id'><i class='halflings-icon edit'></i><span class='hidden-tablet'></span></a>
					
				</td>

				<td class='text-center'>
					<a href='blogdelete.php?id=$id'><i class='halflings-icon trash'></i><span class='hidden-tablet'></span></a>
