...
<body>
		...
		<?php
        	...
        	while($row = mysqli_fetch_array($run_data))
        	{
				...
				<td class='text-center'>
					<a href='aboutuseditform.php?id=$id'><i class='halflings-icon edit'></i><span class='hidden-tablet'></span></a>
					
				</td>

				<td class='text-center'>
					<a href='aboutusdelete.php?id=$id'><i class='halflings-icon trash'></i><span class='hidden-tablet'></span></a>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="aboutusadd.php" method="POST" enctype="multipart/form-data">
